...
[Use JavaScript Arrays Like a Pro](https://javascript.plainenglish.io/how-to-use-javascript-arrays-like-a-pro-3137b3218fef)

[Higher Order Functions In Javascript](https://devdotpy.medium.com/higher-order-functions-in-javascript-and-why-you-should-use-them-more-7c2b9e7e583e)

[Javascript “this” keyword, Explained](https://medium.com/@aflahaliC/javascript-this-keyword-explained-in-terms-of-invocation-patterns-8bf4e2d70cec)

[Arrow Function Best Practices](https://zellwk.com/blog/arrow-function-best-practices/)
...
[How scope works in JavaScript](https://gomakethings.com/how-scope-works-in-javascript/)
...
[Ways to Check If an Object Has a Property](https://dmitripavlutin.com/check-if-object-has-property-javascript/)

[Javascript Tips and Best Practices](https://medium.com/@girish.mehra713/javascript-tips-and-best-practices-5a73a0b3e513)
...
[Template literals and string interpolation in vanilla JS](https://gomakethings.com/template-literals-and-string-interpolation-in-vanilla-js/)

[Ways to Write an Immediately Invoked Function Expression (IIFE)](https://gomakethings.com/the-many-ways-to-write-an-immediately-invoked-function-expression-iife-in-javascript/)
...
[Cross Browser Testing Cloud](https://www.lambdatest.com/)

[The Network built for Coders](https://www.showwcase.com/)

https://app.daily.dev/search?q=CSS+Grid+Layout+Module

[An open-source Shopify alternative](https://medusajs.com/)
...
/*  How to size text using ems - MUST READ  */

https://callmenick.com/dev/jquery-functions-javascript-equivalents/
...
/* Move to the correct categories */


[The ONLY Situation To Use ‘==’ In JavaScript](https://medium.com/@ambroseliew1998/the-only-situation-to-use-in-javascript-1b953b0a3b4b)

[CSS transitions with Animate CSS Grid](https://blog.logrocket.com/creating-smoother-css-transitions-animate-css-grid/)

[Masking images in CSS with the mask-image property](https://blog.logrocket.com/css-mask-image-property/)

[Deep dive into the CSS :where() and :is() functions](https://blog.logrocket.com/deep-dive-css-where-is-functions/)

[Optimizing video backgrounds in CSS and JavaScript](https://blog.logrocket.com/optimizing-video-backgrounds-css-javascript/)

[text styling with the CSS mix-blend-mode property](https://blog.logrocket.com/creative-text-styling-with-the-css-mix-blend-mode-property/)

[JavaScript tools for color generation](https://blog.logrocket.com/6-javascript-tools-color-generation/)

[A complete guide to using CSS filters with SVGs](https://blog.logrocket.com/complete-guide-using-css-filters-svgs/)

[Understanding animation and transition timing functions](https://blog.logrocket.com/understanding-animation-transition-timing-functions-css/)

[CSS header styles with cross-browser compatibility](https://blog.logrocket.com/five-cool-css-header-styles-with-cross-browser-compatibility/)

[ways to style CSS box-shadow effects](https://blog.logrocket.com/three-ways-style-css-box-shadow-effects/)

[Scroll animation using the JavaScript build in Intersection Observer AP](https://adelpro.medium.com/scroll-animation-using-the-javascript-build-in-intersection-observer-api-third-party-libraries-b3ed0a6286bd)

[Ultimate Guide To LocalStorage In JavaScript](https://blog.openreplay.com/the-ultimate-guide-to-localstorage-in-javascript/)

[CSS Positioning from A to Z](https://levelup.gitconnected.com/understanding-css-positioning-from-a-to-z-407927b766ba)


[map, filter & reduce](https://www.youtube.com/watch?v=zdp0zrpKzIE)

[Reduce: 10 Different Examples](https://www.youtube.com/watch?v=NiLUGy1Mh4U)

[Reduce Advanced - Part 4](https://www.youtube.com/watch?v=1DMolJ2FrNY)

[16.6: Array Functions: map() and fill()](https://www.youtube.com/watch?v=EnYlhbpzhU4)
